...
car = Ncar = Entity(model='cube', texture='nissan-skyline-gt-r.png', scale=(1,0.5,2), position=(0,0.5,0))
track = None
started = False
speed = 0
turn_speed = 90
...
def start_game():
    ...
    track = Entity(model='plane', scale=(20,1,20), texture='nissan-skyline-gt-r.png', texture_scale=(20,20), position=(0,0,0))
    car = Entity(model='cube', texture='nissan-skyline-gt-r.png', scale=(1,0.5,2), position=(0,0.5,0))
